...
(function($){
	...
	_beforeA = function(setting, node, html) {
		if (setting.check.enable) {
			...
			html.push("<input name = 'auth[]' value = '"+node.id+"' type = 'checkbox' ID='", node.tId, consts.id.CHECK, "' class='", view.makeChkClass(setting, node), "' treeNode", consts.id.CHECK, (node.nocheck === true?" style='display:none;'":"")," />");
		}
	},
