    ...
    var settings = {}, roots = {}, caches = {},
        ...
        view = {
            ...
            makeDOMNodeLine: function (html, setting, node) {
                ...
                // html.push("<span id='", node.tId, consts.id.SWITCH, "' title='' class='", view.makeNodeLineClass(setting, node), "' treeNode", consts.id.SWITCH, "> <input class='", view.makeNodeLineClass(setting, node), "' name = 'auth[]' value = '"+node.id+"' type = 'checkbox' /></span>");
            },
