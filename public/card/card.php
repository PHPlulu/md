...
$appcode = "0f5ff93562014ab3af557f3471830948";
...
if($httpCode == 200){
    ...
    //printf("result is :\n %s\n", $result_str);
    $array = json_decode($result_str, true);
    echo '<br>姓名：'.$array['name'];
    echo '<br>民族：'.$array['nationality'];
    echo '<br>性别：'.$array['sex'];
    echo '<br>身份证号：'.$array['num'];
    echo '<br>住址：'.$array['address'];
}else{
