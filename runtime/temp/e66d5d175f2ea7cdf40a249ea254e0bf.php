<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"E:\PHPTutorial\WWW\md\public/../application/index\view\come_channel\t3.html";i:1533278870;s:66:"E:\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
					...
					<div class="shezhiysbiao">
						<table class="table table-bordered">
						  ...
						  <tbody class="wlist">
                            ...
                            <?php foreach($t3 as $k=>$vo): ?>
    						    <tr class="tr_<?php echo $vo['id']; ?>" row_id = "<?php echo $vo['id']; ?>">
    						      <td class="row_pid" val = "<?php echo $vo['pid']; ?>"><?php echo $t1[$vo['pid']]['title']; ?></td>
    						      <td class="row_ppid" val = "<?php echo $vo['ppid']; ?>"><?php echo $t2[$vo['ppid']]['title']; ?></td>
