<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:68:"F:\phpstudy\WWW\md\public/../application/index\view\finan\hlist.html";i:1533711840;s:63:"F:\phpstudy\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
          ...
          <div class="wupfei">
            ...
            <div class="conbiao wupfeib">
              <table class="table table-bordered">
                ...
                <tbody>
                <?php if(is_array($hlist) || $hlist instanceof \think\Collection || $hlist instanceof \think\Paginator): $i = 0; $__LIST__ = $hlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?>
                  <tr onclick="set('<?php echo $list['id']; ?>')">
                    ...
                    <td><?php echo $sysyst[$list['sysysid']]['title']; ?></td>
                    <td><?php echo $list['wd']; ?></td>
                    <td><?php echo $list['cd']; ?></td>
                    <td><?php echo $list['hd']; ?></td>
                    <td><?php echo $row_staff[$list['staffid']]['nickname']; ?></td>
                  </tr>
...
function set(id){
   var index=layer.confirm('是否确认该收费记录？', {
      btn: ['确定','取消'] //按钮
        ...
        $.ajax({
            type        : 'post',
            url         : '<?php echo url('finan_set_hlist'); ?>',
            dataType    : 'json',
            data        : {
                id : id
            },
