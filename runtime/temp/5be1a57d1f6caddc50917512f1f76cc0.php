<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"D:\phpstudy\PHPTutorial\WWW\md\public/../application/index\view\contacts\visit_log.html";i:1532427737;s:75:"D:\phpstudy\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
      ...
      <tbody>
        ...
        <?php foreach($list as $k => $vo): ?>
            <tr>
              ...
              <td>
                <?php if($vo['transaction_status'] == 1): ?>
                  成交
                <?php else: ?> 
                  未成交
                <?php endif; ?>
...
<script type="text/javascript">
    function setmw(id,cid){
      ...
      var index=layer.confirm('您确定关联此墓位吗？', {
        ...
        layer.close(index);
          ...
          $.ajax({
              type        : 'post',
              url         : '<?php echo url('set_visit_img_mw'); ?>',
              dataType    : 'json',
              data        : {
                  id : id,
                  cid:cid,
    ...
    function set_img(id,cid){
      imghtml = layer.load(0, {
        ...
        $.ajax({
            type        : 'post',
            url         : '<?php echo url('set_visit_img'); ?>',
            dataType    : 'json',
            data        : {
                id : id,
                cid:cid,
    ...
    function setreload(){
      ...
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('setopen_visit_log'); ?>',
          dataType    : 'json',
          data        : {
              cem_id : cem_id,
