<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"E:\PHPTutorial\WWW\md\public/../application/index\view\finan\muweit.html";i:1533802936;s:66:"E:\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
var cem_row_id = $('.add_row').find('.cem_row_id').val();
  window.location.href="<?php echo url('/index/Finan/muweit/cem_id/"+cem_id+"/cem_area_id/"+cem_area_id+"/cem_row_id/"+cem_row_id+"'); ?>";
});*/
$(function(){
...
$('.show_all').click(function(){
  $(".wlistall").remove();
    ...
    $.ajax({
        type        : 'POST',
        url         : '<?php echo url('Finan/muweit_sell_all'); ?>',
        data        : {
            cem_id : cem_id,
...
function set(id){
   var index=layer.confirm('是否确认该收费记录？', {
      btn: ['确定','取消'] //按钮
        ...
        $.ajax({
            type        : 'post',
            url         : '<?php echo url('finan_set_muweit'); ?>',
            dataType    : 'json',
            data        : {
                id : id
            },
