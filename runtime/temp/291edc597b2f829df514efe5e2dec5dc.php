<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:83:"D:\phpstudy\PHPTutorial\WWW\md\public/../application/index\view\statistic\come.html";i:1534519706;s:75:"D:\phpstudy\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
<script type="text/javascript">
 $(".show_print").click(function(){
  ...
  if(endtime != "" && starttime!=''){
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('show_all_come'); ?>',
          dataType    : 'json',
          data        : {
              starttime:starttime,
              endtime:endtime,
