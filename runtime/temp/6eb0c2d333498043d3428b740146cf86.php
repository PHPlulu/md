<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:72:"F:\phpstudy\WWW\md\public/../application/index\view\statistic\dailm.html";i:1532894388;s:63:"F:\phpstudy\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
<script type="text/javascript">
  ...
  $(".show_all_dailm").click(function(){
    ...
    if(starttime!='' && endtime!=''){
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('show_all_dailm'); ?>',
          dataType    : 'json',
          data        : {
              starttime:starttime,
              endtime:endtime,
