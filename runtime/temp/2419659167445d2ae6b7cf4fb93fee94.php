<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:71:"E:\PHPTutorial\WWW\md\public/../application/index\view\grave\glist.html";i:1534512507;s:66:"E:\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
      ...
      <!--</div>-->
        <div class="lxd">
          ...
          <input class="Wdate xiaostime" name="time" id="starttime" value="<?php echo (isset($Tink['get']['time']) && ($Tink['get']['time'] !== '')?$Tink['get']['time']:date('Y-m-d',time())); ?>" type="text" onclick="WdatePicker()" style="outline: 0;font-size: 14px;color: #000;float: left;margin-left: 10px;width:100px;">
            <!--<input type="text" name="time" class="lxc"/>-->
            <p>时间格式：2013-1-1</p>
          <input type="submit" value="查询" class="lxb">
          <a href="glist.html"><div class="lxb">退出</div></a>
        <!--<div class="lxb">查询</div>-->
            <!--<div class="lxb">退出</div>-->
        </div>
        <div class="lxd">
          <p>查询结果数量：</p>
            <i><?php echo count($list); ?>个</i>
