<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"E:\PHPTutorial\WWW\md\public/../application/index\view\tomb\sale.html";i:1535078534;s:66:"E:\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
<script type="text/javascript">
  ...
  function subres() {
    ...
    var closess = layer.confirm('请核实信息无误，？', {
      ...
      if (reserve_date != '' && remind_date != '' && money != '' && reserve_money != '' && unpaid_money != '' && contacts_name != '' && contacts_postcode != '' && contacts_idcard != '' && contacts_sex != '' && contacts_tel != '' && salesman != '') {
        var html = layer.load(0, {
          shade: [0.5] //0.1透明度的白色背景
        });
        $.ajax({
...
//    }
    ...
    var closeaa = layer.confirm('请确认信息无误，点击确认？', {
      ...
      if (mw_price != '' && manage_money != '' && manage_year != '' && settime != '' && starttime != '' && endtime != '' && contacts_name != '' && contacts_idcard != '' && contacts_tel != '') {
