<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"D:\phpstudy\PHPTutorial\WWW\md\public/../application/index\view\statistic\zf.html";i:1534645108;s:75:"D:\phpstudy\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
/*
  function che(cem){
    ...
    $.ajax({
        type        : 'post',
        url         : '<?php echo url('select_zf_list'); ?>',
        dataType    : 'json',
        data        : {
            id : cem,
        },
  ...
  $(".show_all").click(function(){
    ...
    if(starttime!='' && endtime!=''){
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('select_zf_list_time'); ?>',
          dataType    : 'json',
          data        : {
              id : cem,
              starttime : starttime,
  ...
  function setalltr(id){
    ...
    $.ajax({
        type        : 'post',
        url         : '<?php echo url('select_zf_list_all'); ?>',
        dataType    : 'json',
        data        : {
            id : id,
        },
