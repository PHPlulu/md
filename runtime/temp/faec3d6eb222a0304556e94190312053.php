<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\phpstudy\PHPTutorial\WWW\md\public/../application/index\view\statistic\qudao.html";i:1534582810;s:75:"D:\phpstudy\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
  ...
  $('#qudao2').change(function(){
    ...
    $(".show_all").click(function(){
      ...
      if(starttime!='' && endtime!=''){
        $.ajax({
            type        : 'post',
            url         : '<?php echo url('show_qudao_all_time'); ?>',
            dataType    : 'json',
            data        : {
                cem_id1 : cem_id1,
                cem_id2:cem_id2,
        ...
        $.ajax({
            type        : 'post',
            url         : '<?php echo url('show_qudao_all'); ?>',
            dataType    : 'json',
            data        : {
                cem_id1 : cem_id1,
                cem_id2:cem_id2,
