<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:77:"E:\PHPTutorial\WWW\md\public/../application/index\view\statistic\mwcount.html";i:1533730981;s:66:"E:\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
<script type="text/javascript">
 /* $(function(){
  ...
  function setper(id){
    ...
    $.ajax({
        type        : 'post',
        url         : '<?php echo url('select_count_list_all'); ?>',
        dataType    : 'json',
        data        : {
            id : id,
        },
  ...
  function buy(cem){
    ...
    if(cem && start && end){
       $.ajax({
          type        : 'post',
          url         : '<?php echo url('select_cem_list'); ?>',
          dataType    : 'json',
          data        : {
              id : cem,
              starttime:start,
  ...
  $(".show_all").click(function(){
    ...
    if(start && end){
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('select_cem_list_all_time'); ?>',
          dataType    : 'json',
          data        : {
              id : 'all',
              starttime : start,
      ...
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('select_cem_list_all'); ?>',
          dataType    : 'json',
          data        : {
              id : 'all',
          },
