<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"E:\PHPTutorial\WWW\md\public/../application/index\view\statistic\mwsell.html";i:1534517277;s:66:"E:\PHPTutorial\WWW\md\public/../application/index\view\layout.html";i:1533793060;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
...
$(".show_mwsell_all").click(function(){
  ...
  if(endtime != ""){
      $.ajax({
          type        : 'post',
          url         : "<?php echo url('show_mwsell_all_time'); ?>",
          dataType    : 'json',
      ...
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('show_mwsell_all'); ?>',
          dataType    : 'json',
          data        : {
              id : cem,
              area:area,
...
$(".show_all_mwsell").click(function(){
    ...
    if(endtime != ""){
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('select_mwsell_list_time'); ?>',
          dataType    : 'json',
          data        : {
              id : cem,
              area:area,
      ...
      $.ajax({
          type        : 'post',
          url         : '<?php echo url('select_mwsell_list'); ?>',
          dataType    : 'json',
          data        : {
              id : cem,
              area:area,
